...
@Test
	...
	driver.findElement(By.xpath("//*[@id=\"navi_wrap\"]/nav/ul/li[3]/a/span")).click(); //아이반찬 카테고리 click
	driver.findElement(By.xpath("//*[@id=\"navi_wrap\"]/nav/ul/li[4]/a/span")).click(); //정기식단 카테고리 click
	driver.findElement(By.xpath("//*[@id=\"navi_wrap\"]/nav/ul/li[5]/a/span")).click(); //신선간편 카테고리 click
	driver.findElement(By.xpath("//*[@id=\"navi_wrap\"]/nav/ul/li[6]/a/span")).click(); //간식 카테고리 click
	driver.findElement(By.xpath("//*[@id=\"navi_wrap\"]/nav/ul/li[7]/a/span")).click(); //브랜드관 카테고리 click
